...
type VoteServiceClient interface {
	ComputeVote(ctx context.Context, in *Vote, opts ...grpc.CallOption) (*VoteResponse, error)
}
...
func (c *voteServiceClient) ComputeVote(ctx context.Context, in *Vote, opts ...grpc.CallOption) (*VoteResponse, error) {
	out := new(VoteResponse)
	err := c.cc.Invoke(ctx, "/pb.VoteService/ComputeVote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VoteServiceServer interface {
	ComputeVote(context.Context, *Vote) (*VoteResponse, error)
...
func (UnimplementedVoteServiceServer) ComputeVote(context.Context, *Vote) (*VoteResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ComputeVote not implemented")
}
...
func _VoteService_ComputeVote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Vote)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VoteServiceServer).ComputeVote(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.VoteService/ComputeVote",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VoteServiceServer).ComputeVote(ctx, req.(*Vote))
	}
...
var VoteService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ComputeVote",
			Handler:    _VoteService_ComputeVote_Handler,
		},
	},
